...
- bootstrap skill availability in current project's `.cursor/skills/`
...
Global/home-level installs do not count as `present` unless copied or synced into the current project's `.cursor/skills/`.
